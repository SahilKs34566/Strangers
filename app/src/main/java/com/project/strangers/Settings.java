...
import com.project.strangers.Models.Users;
import com.project.strangers.databinding.ActivitySettingsBinding;
    ...
    binding.saveButton.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if(!binding.etStatus.getText().toString().equals("") && !binding.txtUsername.getText().toString().equals("")){
                ...
                Toast.makeText(Settings.this, "first Enter the information", Toast.LENGTH_SHORT).show();
            }
